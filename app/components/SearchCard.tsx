...
export default function SearchCard() {
  ...
  // ফাইল আপলোড হ্যান্ডলার - যেকোনো ফরম্যাট সাপোর্ট করবে
      ...
      try {
        ...
        if (file.name.endsWith('.csv')) {
          ...
          for (const line of lines) {
            ...
            // বিভিন্ন ফরম্যাট সাপোর্ট করার জন্য
            if (values.length >= 9) {
              // ফরম্যাট 1: Roll,Choice1,Result1,Choice2,Result2,Choice3,Result3,Choice4,Result4
              data.push({
                id: values[0],
                choices: [
              ...
              // ফরম্যাট 2: Roll,Department1,Result1,Department2,Result2,...
              const choices = [];
  ...
  // Function to determine the badge color based on result
  ...
  return (
    <div className="max-w-md mx-auto bg-white rounded-lg shadow-md overflow-hidden border border-gray-200">
      ...
      {showAdminLogin && (
        <div className="fixed inset-0 bg-gray-200 bg-opacity-50 flex items-center justify-center z-50">
          ...
          <div className="bg-white p-6 rounded-lg shadow-xl w-80">
            <h2 className="text-1 font-normal mb-4"> This is made with by RIMON </h2>
      ...
      {/* শুধুমাত্র অ্যাডমিন মোডে ফাইল আপলোড সেকশন দেখাবে */}
      {adminMode && (
        <div className="p-4 bg-blue-50 border-b border-gray-200">
          ...
          <p className="text-xs text-gray-600 mt-2">
            Supported CSV formats:<br/>
            1. Roll,Choice1,Result1,Choice2,Result2,Choice3,Result3,Choice4,Result4<br/>
            2. Roll,Dept1,Result1,Dept2,Result2,Dept3,Result3,Dept4,Result4
          </p>
          {fileData.length > 0 && (
        ...
        {result && (
          <div className="space-y-1">
            ...
            <div className="space-y-3">
              {result.choices && result.choices.map((choice: any, index: number) => (
                <div key={index} className="flex justify-between items-center p-3 bg-gray-50 rounded-lg">
                  <div className="flex items-center">
                    <span className="text-lg mr-2">●</span>
                    <div>
                      <span className="font-semibold text-gray-700">
                        {choice.choice_number === 1 ? "1ST" : 
                         choice.choice_number === 2 ? "2ND" : 
                         choice.choice_number === 3 ? "3RD" : "4TH"} CHOICE
                      </span>
